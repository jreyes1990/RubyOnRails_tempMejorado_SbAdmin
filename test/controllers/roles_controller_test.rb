...
class RolesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create rol" do
    assert_difference('Rol.count') do
      post roles_url, params: { rol: { descripcion: @rol.descripcion, estado: @rol.estado, nombre: @rol.nombre, user_created_id: @rol.user_created_id, user_updated_id: @rol.user_updated_id } }
    end
